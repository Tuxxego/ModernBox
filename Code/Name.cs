...
namespace ModernBox
{
    class Name : MonoBehaviour
	{
        ...
        public static void init()
		{
		    ...
		    ModernNames.templates.Add("part_group");
            AssetManager.nameGenerator.add(ModernNames);
		    ...
		    ModernOrcNames.templates.Add("part_group");
            AssetManager.nameGenerator.add(ModernOrcNames);
		    ...
		    ModernElfNames.templates.Add("part_group");
            AssetManager.nameGenerator.add(ModernElfNames);
		    ...
		    ModernDwarfNames.templates.Add("part_group");
            AssetManager.nameGenerator.add(ModernDwarfNames);
		    ...
		    JetNames.templates.Add("part_group");
            AssetManager.nameGenerator.add(JetNames);
		    ...
		    HumveeNames.templates.Add("part_group");
            AssetManager.nameGenerator.add(HumveeNames);
		    ...
		    MIRVNames.templates.Add("part_group");
            AssetManager.nameGenerator.add(MIRVNames);
        ...
        {
            ActorAsset human = AssetManager.actor_library.get(SA.unit_human);
			human.nameTemplate = "Modern_Names";

            ActorAsset humanbaby = AssetManager.actor_library.get(SA.baby_human);
			humanbaby.nameTemplate = "Modern_Names";
		...
		public static void turnOnOtherNames()
        {
            ...
            ActorAsset orc = AssetManager.actor_library.get(SA.unit_orc);
			orc.nameTemplate = "Modern_Orc_Names";


            ActorAsset orcbaby = AssetManager.actor_library.get(SA.baby_orc);
			orcbaby.nameTemplate = "Modern_Orc_Names";
			
			ActorAsset elf = AssetManager.actor_library.get(SA.unit_elf);
			elf.nameTemplate = "Modern_Elf_Names";


            ActorAsset elfbaby = AssetManager.actor_library.get(SA.baby_elf);
			elfbaby.nameTemplate = "Modern_Elf_Names";
			
			ActorAsset dwarf = AssetManager.actor_library.get(SA.unit_dwarf);
			dwarf.nameTemplate = "Modern_Dwarf_Names";


            ActorAsset dwarfbaby = AssetManager.actor_library.get(SA.baby_dwarf);
			dwarfbaby.nameTemplate = "Modern_Dwarf_Names";
		...
		public static void turnOffOtherNames()
        {
            ...
            ActorAsset orc = AssetManager.actor_library.get(SA.unit_orc);
			orc.nameTemplate = "orc_name";


            ActorAsset orcbaby = AssetManager.actor_library.get(SA.baby_orc);
			orcbaby.nameTemplate = "orc_name";
			
			ActorAsset elf = AssetManager.actor_library.get(SA.unit_elf);
			elf.nameTemplate = "elf_name";


            ActorAsset elfbaby = AssetManager.actor_library.get(SA.baby_elf);
			elfbaby.nameTemplate = "elf_name";
        ...
        public static void turnOffNames()
        {
            ...
            ActorAsset human = AssetManager.actor_library.get(SA.unit_human);
			human.nameTemplate = "human_name";


            ActorAsset humanbaby = AssetManager.actor_library.get(SA.baby_human);
			humanbaby.nameTemplate = "human_name";
