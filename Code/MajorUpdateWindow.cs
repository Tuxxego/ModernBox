...
namespace ModernBox
{
    class MajorUpdateWindow
    {
        public static void init()
        {
          var window = Windows.CreateNewWindow("MajorUpdateWindow", "ModernBox");
          ...
          string Dgold = "#ffae00";
          var description =
@"<color='" + gold + @"'>[Major Update Coming Soon!! ]</color>

A major update for ModernBox is releasing soon, be on the lookout! Some new things will be: trench warfare, APCs, new commercial buildings, modern soldiers, and more!";
