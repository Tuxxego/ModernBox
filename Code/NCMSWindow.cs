...
namespace ModernBox
{
    class NCMSWindow
    {
        ...
        {
          var window = Windows.CreateNewWindow("NCMSWindow", "ModernBox");
...
It seems you are using NCMS, consider upgrading from NCMS to NML as NCMS is obsolete and no longer being updated by its creator.";
